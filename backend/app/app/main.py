...
from app.database import AsyncSessionLocal, DocumentRecord, init_db
...
async def upload_document(
    ...
    try:
        ...
        (
            ...
            accessible_text,
            equations,
        ) = await ingestion_service.process_file(saved_path, file.filename)
...
async def generate_study_content(
    ...
    try:
        ...
        if req.generate_audio:
            audio_filename = await AudioService.text_to_speech(
